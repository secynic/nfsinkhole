...
# -*- coding: utf-8 -*-
#
# nfsinkhole documentation build configuration file, created by
...
autodoc_mock_imports = ['fcntl', 'os.geteuid']
...
project = 'nfsinkhole'
copyright = '2016-2017, Philip Hane'
...
htmlhelp_basename = 'nfsinkholedoc'
...
latex_documents = [
  ('index', 'nfsinkhole.tex', 'nfsinkhole Documentation',
   'secynic', 'manual'),
]
